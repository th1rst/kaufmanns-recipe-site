                    ...
                    <Carousel.Item>
                      <Link to={`/rezepte/${recipe.slug}`}>
                        ...
                        <Carousel.Caption>
                          ...
                          {recipe.subtext ? (
                            <p className="carousel-subtext">{recipe.subtext}</p>
                          ) : null}
                        </Carousel.Caption>
                      </Link>
                    </Carousel.Item>
        ...
        <div className="home-row-2">
          <div className="featured-recipes-container">
            <p className="featured-recipes-heading">
              Die PDF-Version des Buchs mit 237 Seiten zum kostenlosen Download
            </p>
            <a
              href="https://kochannek.com/portfolio/kaufmanns-rezeptsammlung/KaufmannsSpitzenRezeptsammlung.pdf"
              download
            >
