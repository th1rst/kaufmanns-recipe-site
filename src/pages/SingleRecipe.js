  ...
  return (
    <div>
      ...
      <div className="single-recipe-container">
        {recipes.map((recipe) => {
          if (recipe.slug === props.match.params.slug) {
            ...
            return (
              <div key={Math.random() * 10000}>
                <div className="single-recipe-heading-row">
                  ...
                  {recipe.subtext ? (
                    <p className="single-recipe-subheading">{recipe.subtext}</p>
                  ) : null}
                  <div className="divider-medium-large" />
                  <div className="single-recipe-properties-container">
                    ...
                    <div className="properties-inner-container">
                      ...
                      <p className="properties-text">
                        {getDuration(recipe.timeNeeded)}
                      </p>
                      {recipe.cookingTime ? (
                        <p className="properties-text-small">
                          + {getDuration(recipe.cookingTime)} extra
                        </p>
                      ) : null}
                    </div>
                    <div className="properties-inner-container">
                      ...
                      <div className="single-recipe-difficulty-container">
                        {displayDifficulty(recipe.difficulty)}
                      </div>
